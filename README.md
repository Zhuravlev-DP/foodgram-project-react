![workflow status](https://github.com/Zhuravlev-DP/foodgram-project-react/actions/workflows/foodgram_workflow.yml/badge.svg)

Проект доступен по адресу: http://158.160.106.232

Документация к API проекта: http://158.160.106.232/api/docs/
...
```bash
git clone git@github.com:Zhuravlev-DP/foodgram-project-react.git
cd infra
```
